...
export class WeaponImporter extends DataImporter {
    ...
    parse(jsonObject) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let weaponsFolder = yield ImportHelper.NewFolder("Weapons");
            ...
            for (let i = 0; i < jsonCategories.length; i++) {
                ...
                weaponCategoryFolders[categoryName] = yield ImportHelper.NewFolder(categoryName, weaponsFolder);
            }
            weaponCategoryFolders["Gear"] = yield ImportHelper.NewFolder("Gear", weaponsFolder);
            weaponCategoryFolders["Quality"] = yield ImportHelper.NewFolder("Quality", weaponsFolder);
            //DONE
